...
var weekday = prompt("What is week day today?: ")
var vacation = prompt("Are you on vacantion?: ")
function sleepIn(weekday, vacation='vac') {
    //Code Goes Here
    var weekdays = ['Monday','Tuesday','Wednesday','Thursday','Friday']
    weekday_state = weekdays.includes(weekday)
    console.log(weekday_state)
    vacation_state = ((weekday_state && ) ?)
